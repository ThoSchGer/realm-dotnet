...
namespace SourceGeneratorAssemblyToProcess
{
    ...
    internal partial class IndexedClass : IRealmObject, INotifyPropertyChanged, IReflectableType
    {
        ...
        static IndexedClass()
        {
            Realms.Serialization.RealmObjectSerializer.Register(new IndexedClassSerializer());
        }
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
        private class IndexedClassManagedAccessor : Realms.ManagedAccessor, IIndexedClassAccessor
        {
            public int Id
            {
                get => (int)GetValue("Id");
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Realms.Preserve(AllMembers = true)]
        private class IndexedClassUnmanagedAccessor : Realms.UnmanagedAccessor, IIndexedClassAccessor
        {
        ...
        private class IndexedClassSerializer : Realms.Serialization.RealmObjectSerializerBase<IndexedClass>
        {
            ...
            protected override void SerializeValue(MongoDB.Bson.Serialization.BsonSerializationContext context, BsonSerializationArgs args, IndexedClass value)
            {
                ...
                WriteValue(context, args, "FullTextProp", value.FullTextProp);
                WriteValue(context, args, "NullableFullTextProp", value.NullableFullTextProp);
            ...
            protected override IndexedClass CreateInstance() => new IndexedClass();

            protected override void ReadValue(IndexedClass instance, string name, BsonDeserializationContext context)
            {
                switch (name)
                {
                    case "Id":
                        ...
                        break;
                    case "FullTextProp":
                        instance.FullTextProp = BsonSerializer.LookupSerializer<string>().Deserialize(context);
                        break;
                    case "NullableFullTextProp":
                        instance.NullableFullTextProp = BsonSerializer.LookupSerializer<string?>().Deserialize(context);
                        break;
                    case "IntProp":
                        instance.IntProp = BsonSerializer.LookupSerializer<int>().Deserialize(context);
                        break;
                    case "GuidProp":
                        instance.GuidProp = BsonSerializer.LookupSerializer<System.Guid>().Deserialize(context);
                        break;
                    case "GeneralGuidProp":
            ...
            protected override void ReadArrayElement(IndexedClass instance, string name, BsonDeserializationContext context)
            {
                // No persisted list/set properties to deserialize
            }

            protected override void ReadDocumentField(IndexedClass instance, string name, string fieldName, BsonDeserializationContext context)
            {
